...
The following listing shows a layout file called _activity_listviewexampleactivity.xml_ which includes a `ListView`.
...
The following example shows the usage of the `ListView` view in an activity. 
