...
Create the following _activity_main.xml_ layout file based on the `port` resource qualifier for orientation.

[source,xml]
----
include::res/fragments/activity_main2.xml[]
----
...
Create the same file for the landscape configuration with a different value.
This file is located in your _res/values-land_ folder.
